...
\begin{frame}
  ...
  \begin{block}{}
    Hemos visto la estructura de una mónada, aunque todavía
    desconocemos todo su potencial. No obstante, hemos visto cómo nos
    pueden ayudar para gestionar errores y describir un sistema de
    Logging.
  \end{block}
  ...
  \begin{block}{}
    El próximo día veremos la mónada Lista, que nos permite introducir
    no determinismo, y la mónada Estado, que nos enseñará que
    paradigmas funcional e imperativos no están tan reñidos como
    podemos pensar.
  \end{block}
\end{frame}
